...
public class Values {
    ...
    public static String submit = "Підтвердити";
    ...
    public static String manifest = "Маніфест";

    public static String dialogAbout = "Тут буде якась інфа про мене.";

    public static String dialogManifest = "Тут буде маніфест проекту.";

    public static String alreadyInDatabase = "Ти вже писав!";

    public static String successAdding = "Запис додано.";
}
