...
public class MainView extends VerticalLayout {
    ...
    private final Button showAllButton = new Button(Values.showAll);
    ...
    public MainView() {
        ...
        successAddingNotification.setPosition(Notification.Position.BOTTOM_END);
    ...
    private void setButtons() {
        ...
        submitLayout.add(submitButton, showAllButton);
        ...
        showAllButton.addClickListener((ComponentEventListener<ClickEvent<Button>>) buttonClickEvent -> {
    ...
    private void addItem(String name, String email, LocalDate date, String text) {
        if (!controller.isTextCorrect(text)) {
            ...
            successAddingNotification.open();
            clearFields();
        }
    }
